...
The frequency is estimated using continuous Wavlet transfrom (CWT) using the Python module [PyWavelets](https://pywavelets.readthedocs.io/en/latest/). Frequency bins are chosen in the range [0.937, 30] Hz with each bin being a factor of 1.16263 higher than the previous bin, and 30 Hz is the Nyquist limit for the recordings with a camera frame rate of 60 Hz. 
